...
class root_window:
    ...
    def create_crud_buttons(self):
        ...
        for btn_info in buttons_info:
            Button(self.crud_frame, text= btn_info[0], bg = btn_info[1], fg="white", font=("Ariel", 12), padx=2, pady=2, width=20).grid(row=self.row_no, column=self.col_no, padx=5, pady=10)
            self.col_no+=1
